...
import (
	...
	"github.com/kristianhuang/go-component/log"
)
...
func main() {
	...
	// log.V(log.FatalLevel).Infow("This is a V level message with fields", "X-Request-ID", "7a7b9f24-4cae-4b2a-9464-69088b45b904")
